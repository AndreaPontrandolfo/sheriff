...
<a href="https://github.com/AndreaPontrandolfo/sheriff" className="flex items-center gap-2">
  <IoLogoGithub /><span>Github Link</span>
</a>
<a href="https://www.npmjs.com/package/eslint-config-sheriff" className="flex items-center gap-2">
  <IoLogoNpm /><span>npm Link</span>
</a>
