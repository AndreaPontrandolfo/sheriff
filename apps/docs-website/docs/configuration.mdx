...
Covered here: [♻ Migration guide](./migration-guide.mdx)

### `ignores`

By default, Sheriff ignores a list of commonly ignored folders (`/node_modules/`, `/build/`, `/dist/`, etc...) and the files specified in your .gitignore file. You can disable any of these settings by passing `false` to them.
