...
TypeScript configuration is a vast and complex topic.
Depending on the environments that you are going to target,
setting up correctly a proper `tsonfig` can be daunting and time-consuming.<br />
This section will illustrate the choices
that you should make when tweaking a `tsconfig` in a modern TypeScript project that uses Sheriff.

If you don’t know much about `tsconfig`s and are uncertain what do choose,
this can be a good starting point.
In the end, however, you must be sure the chosen settings fit your project.
...
```JSONC title="tsconfig.json"
{
  ...
  "compilerOptions": {
    ...
    "jsx": "react-jsx",
    "composite": false, // You should only enable this if you’re using TS project references, but they are fairly discouraged nowadays.
    "incremental": true,
    ...
    "exactOptionalPropertyTypes": false, // This looks nice on paper, but is actually extremely annoying in practice due to lack of ecosystem buy-in. Keep it off in applications. However, if you’re writing a library, you may wish turn it on to maximize compatibility.
