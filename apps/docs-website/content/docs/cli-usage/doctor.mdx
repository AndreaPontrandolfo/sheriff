...
The Doctor is very flexible and offers a variety of options to customize it's behavior. Check out the [API reference](/docs/cli-usage/commands-reference#sherifforgcli) for detailed info on the available options.
