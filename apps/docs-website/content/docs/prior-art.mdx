...
None of these projects share the same set of goals as Sheriff.<br />
...
Sheriff instead was [shaped around solid principles](./core-philosophy/criteria.mdx) and only includes the rules that let it achieve its goals.
