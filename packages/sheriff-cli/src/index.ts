...
async function main() {
  try {
    ...
    if (!sheriffOptionsVariableDeclaration) {
      ...
      consola.info(
        'No variable named "sheriffOptions" found in ESLint configuration. This could be intended, or maybe you forgot to name the Sheriff options object exactly "sheriffOptions". Check the documentation for more info: https://www.eslint-config-sheriff.dev/docs/cli-usage/get-started#how-it-works',
      );
